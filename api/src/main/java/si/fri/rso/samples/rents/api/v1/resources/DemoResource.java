...
import si.fri.rso.samples.rents.api.v1.dtos.HealthDto;
import si.fri.rso.samples.rents.api.v1.dtos.LoadDto;
import si.fri.rso.samples.rents.services.configuration.AppProperties;
...
public class DemoResource {
    ...
    @POST
    @Path("load")
    public Response loadrent(LoadDto loadDto) {
    ...
    public Response info() {
        ...
        JsonObject json = Json.createObjectBuilder()
                .add("clani", Json.createArrayBuilder().add("TursicKlemen"))
                .add("opis_projekta", "Projekt implementira aplikacijo za izposojo koles.")
                /*.add("mikrostoritve", Json.createArrayBuilder().add("http://35.204.91.158:8081/v1/rents"))
